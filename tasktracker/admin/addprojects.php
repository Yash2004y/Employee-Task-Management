            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- Basic form elements -->
                  <form class="forms-sample" onsubmit="return valid()" action="action/addprojects.php" method="post">

                    <div class="form-group">
                      <label for="title">
                        <h6>Project Title</h6>
                      </label>
                      <input type="text" class="form-control" name="title" id="title" placeholder="Project Title" autofocus>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="description" name="description" rows="4" Placeholder="Project Description"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="plateform" name="plateform" placeholder="Project Plateform">
                    </div>
