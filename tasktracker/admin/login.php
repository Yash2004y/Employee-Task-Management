          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" action="#" method="post" onsubmit="return valid()">
                ...
                <div class="mt-3">
                  <input style="width:100%;" type="submit" name="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" value="SIGN IN">
                </div>
                <div class="my-2 d-flex justify-content-between align-items-center">
    ...
    <?php
      if($conn)
      {
        if(isset($_POST["submit"]))
        {
          ...
          $cmd = "select * from admins where emailId='$email'"; 
