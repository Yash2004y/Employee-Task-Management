                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody id="tabbody">
                        ...
                        <?php
                        if ($conn) {
                          // select task.taskId,task.taskTitle,task.startDate,task.endDate,task.status,atask.empId from allocatetasks atask,tasks task where atask.empId = '$emp[empId]' and atask.taskId = task.taskId
                          $result = mysqli_query($conn, "select task.*,atask.* from allocatetasks atask,tasks task where atask.empId = '$emp[empId]' and atask.taskId = task.taskId");
