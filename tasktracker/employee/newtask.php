                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody id="tabbody">
                        <?php
                        if ($conn) {
                          $result = mysqli_query($conn, "select task.*,atask.* from allocatetasks atask,tasks task where atask.empId = '$emp[empId]' and atask.percentage = '0' and atask.taskId = task.taskId");
                        ...
                        ?>
                              <tr>
                                ...
                                <td>
                                  <a href="detailnewtask.php?id=<?php echo htmlentities($row["taskId"]); ?>" class="btn btn-gradient-info">View</a>
                                </td>
                              </tr>
                        <?php
                            }
